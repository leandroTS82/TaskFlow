...
A exibição do quadro é um item importante para mostrar o planejamento e entendimento inicial que depois pode ser refinado.

Exibe alem das escolhas, alguns trade-offs.

Processo baseado no Kanban ajuda na organização e priorização, desde brain storms a simulação de tickets.
